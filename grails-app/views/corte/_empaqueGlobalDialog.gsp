<div class="modal fade" id="empaqueGlobalModal" tabindex="-1" role="dialog"
     aria-labelledby="empaqueGlobalModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="entregarModalLabel">Terminado Global de empacado</h4>
            </div>
            <g:form  controller="corte" action="terminarEmpacadoGlobal" class="form-horizontal">
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#empaqueGlobalModal').on('show.bs.modal', function (event) {
