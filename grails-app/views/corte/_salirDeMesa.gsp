    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="salirModalLabel">Salir de mesa de empaque</h4>
            </div>
            <g:form  name="asignarForm"   action="salirDeMesaDeEmpaque" id="${cortador?.id}">
...
<script type="text/javascript">
    $(document).ready(function(){
      $('#salirModal').on('show.bs.modal', function (event) {
